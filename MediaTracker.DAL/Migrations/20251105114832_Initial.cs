        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserNotes = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_MediaItems_UserRating_Range", "\"UserRating\" IS NULL OR (\"UserRating\" >= 1 AND \"UserRating\" <= 10)");
                    table.ForeignKey(
