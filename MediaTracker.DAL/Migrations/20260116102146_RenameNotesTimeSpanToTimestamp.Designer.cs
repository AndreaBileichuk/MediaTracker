...
namespace MediaTracker.DAL.Migrations
{
    ...
    [Migration("20260116102146_RenameNotesTimeSpanToTimestamp")]
    partial class RenameNotesTimeSpanToTimestamp
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MediaTracker.DAL.Entities.MediaItem", b =>
                {
                    b.HasOne("MediaTracker.DAL.Entities.ApplicationUser", "User")
                        .WithMany("MediaItems")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MediaTracker.DAL.Entities.ApplicationUser", null)
                        .WithMany()
